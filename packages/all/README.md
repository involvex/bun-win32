...
<tr>
<td><img src="https://raw.githubusercontent.com/ObscuritySRL/bun-win32/main/packages/all/screenshots/voxelscape.png" alt="voxelscape"><br><b>voxelscape</b> — a fully playable <b>raytraced voxel physics sandbox</b>: walk/jump/swim/fly a world of falling sand, flooding water, flowing lava (lava+water→obsidian), spreading fire, and chain-reaction TNT with bullet-time — plus AI critters, flying debris, bomb &amp; meteor set-pieces, smooth shadows + AO, real water reflections, an animated day/night sky, glow, a HUD and procedural audio. All Amanatides–Woo DDA in one pixel shader. <code>bun run voxelscape</code></td>
